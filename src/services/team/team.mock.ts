...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    name: "Amira O.",
    initials: "AO",
    role: "Residential Care Worker · 3y",
    home: "Willow House",
  ...
  },
  {
    ...
    name: "Daniel T.",
    initials: "DT",
    role: "Residential Care Worker · 4y",
    home: "Willow House",
    teamId: "team-willow-day",
    hoursThisWeek: 32,
    hoursRequired: 40,
  ...
  },
  {
    ...
    name: "Clara F.",
    initials: "CF",
    role: "Residential Care Worker · 1y",
    home: "Oakmoor House",
    teamId: "team-oakmoor",
    hoursThisWeek: 16,
    hoursRequired: 32,
  ...
  },
  {
    ...
    name: "Tomás R.",
    initials: "TR",
    role: "Senior Residential Care Worker · 6y",
    home: "Willow House",
    teamId: "team-willow-day",
    hoursThisWeek: 40,
    hoursRequired: 40,
  ...
  },
  {
    ...
    name: "Finn O.",
    initials: "FO",
    role: "Residential Care Worker · 2y",
    home: "Oakmoor House",
    teamId: "team-oakmoor",
    hoursThisWeek: 0,
    hoursRequired: 40,
  ...
  },
  {
    ...
    name: "Hiroki T.",
    initials: "HT",
    role: "Residential Care Worker · 5y",
    home: "Willow House",
    teamId: "team-willow-day",
    hoursThisWeek: 28,
    hoursRequired: 40,
